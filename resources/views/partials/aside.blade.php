            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="{{ Request::is("/") ? 'active' : ''  }}">
                        <a href="/admin/home"><i class="menu-icon fa fa-laptop"></i>Panel principal </a>
                    </li>
                    ...
                    <li class="{{ Request::is("admin/categorias*") ? 'active' : ''  }}">
                        <a href="{{ route('categorias.index') }}" aria-haspopup="true"> <i class="menu-icon fa fa-cogs"></i>Categorias</a>
                    </li>
                    ...
                    <li class="{{ Request::is("admin/reporte/venta*") ? 'active' : ''  }}">
                        <a href="{{ route('reportes.ventas') }}" aria-haspopup="true"> <i class="menu-icon fa fa-area-chart"></i> Ventas</a>
                    </li>

                    <li class="{{ Request::is("admin/reporte/cliente*") ? 'active' : ''  }}">
