...
@section('css')
<!-- SPECIFIC CSS -->
    <link href="/frontend/css/product_page.css" rel="stylesheet">
@endsection
    ...
    <div class="page_header">
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="/tienda?categoria_id[]={{ $producto->categoria->id }}">{{ $producto->categoria->nombre }}</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="owl-carousel owl-theme prod_pics magnific-gallery">
                <div class="item">
                    <a href="{{ url('imagenes/'. json_decode($producto->ruta_imagen)->full) }}" title="Photo title" data-effect="mfp-zoom-in"><img src="{{ url('imagenes/'. json_decode($producto->ruta_imagen)->full) }}" alt=""></a>
                </div>
                <!-- /item -->
            </div>
            <!-- /carousel -->
        ...
        <div class="row justify-content-between">
            <div class="col-lg-6">
                <div class="prod_info version_2">
                    ...
                    <p><small>SKU: PRO-00{{ $producto->id }}</small><br>{{ $producto->descripcion }}.</p>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="prod_options version_2">
                    ...
                    <form action="{{ route("accion.agregar_carrito") }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="producto_id" value="{{ $producto->id }}">
                        <div class="row">
                            <label class="col-xl-6 col-lg-5  col-md-6 col-6"><strong>Cantidad</strong></label>
                            <div class="col-xl-6 col-lg-5 col-md-6 col-6">
                                <div class="numbers-row">
                                    <input type="text" value="1" id="quantity_1" class="qty2" name="cantidad">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6 col-md-6">
                                <div class="price_main"><span class="new_price">{{ moneda($producto->precio) }} </span> {{-- <span class="percentage">-20%</span> <span class="old_price">$160.00</span> --}} </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="btn_add_to_cart"><button type="submit" class="btn_1">Agregar al carrito</button></div>
                            </div>
                        </div>
                    </form>
                </div>
